...
> Note: If you are going to fork this project, we recommend basing your work on the 2.0.0-M1-x branch, and not the heat_clinic branch. heat_clinic is our ongoing development branch and there are no guarantees of stability on it.