...
INSERT INTO BLC_CATEGORY_TRANSLATION (TRANSLATION_ID,DESCRIPTION,NAME) VALUES (1001,'Inicio','Inicio');
INSERT INTO BLC_CATEGORY_TRANSLATION (TRANSLATION_ID,DESCRIPTION,NAME) VALUES (1002,'Salsas Picantes','Salsas');
INSERT INTO BLC_CATEGORY_TRANSLATION (TRANSLATION_ID,DESCRIPTION,NAME) VALUES (1003,'Mercanc&iacute;a','Mercanc&iacute;a');
INSERT INTO BLC_CATEGORY_TRANSLATION (TRANSLATION_ID,DESCRIPTION,NAME) VALUES (1004,'Descuento','Descuento');
INSERT INTO BLC_CATEGORY_TRANSLATION (TRANSLATION_ID,DESCRIPTION,NAME) VALUES (1005,'Iniciando con Salsas?','Nuevo a la Salsa?');
INSERT INTO BLC_CATEGORY_TRANSLATION (TRANSLATION_ID,DESCRIPTION,NAME) VALUES (1006,'FAQ','FAQ');
...
INSERT INTO BLC_PRODUCT_OPTION_TRANSLATION (TRANSLATION_ID,LABEL) VALUES (1001,'Color de Camisa');
INSERT INTO BLC_PRODUCT_OPTION_TRANSLATION (TRANSLATION_ID,LABEL) VALUES (1002,'Tama&ntilde;o de Camisa');
...
INSERT INTO BLC_PRODUCT_OPTION_VALUE_TRANSLATION (TRANSLATION_ID,ATTRIBUTE_VALUE) VALUES (1001,'Negro');
INSERT INTO BLC_PRODUCT_OPTION_VALUE_TRANSLATION (TRANSLATION_ID,ATTRIBUTE_VALUE) VALUES (1002,'Rojo');
INSERT INTO BLC_PRODUCT_OPTION_VALUE_TRANSLATION (TRANSLATION_ID,ATTRIBUTE_VALUE) VALUES (1003,'Plateado');
INSERT INTO BLC_PRODUCT_OPTION_VALUE_TRANSLATION (TRANSLATION_ID,ATTRIBUTE_VALUE) VALUES (1011,'CH');
INSERT INTO BLC_PRODUCT_OPTION_VALUE_TRANSLATION (TRANSLATION_ID,ATTRIBUTE_VALUE) VALUES (1012,'M');
INSERT INTO BLC_PRODUCT_OPTION_VALUE_TRANSLATION (TRANSLATION_ID,ATTRIBUTE_VALUE) VALUES (1013,'G');
INSERT INTO BLC_PRODUCT_OPTION_VALUE_TRANSLATION (TRANSLATION_ID,ATTRIBUTE_VALUE) VALUES (1014,'XG');
...
INSERT INTO BLC_SKU_TRANSLATION (TRANSLATION_ID,DESCRIPTION,NAME,LONG_DESCRIPTION) VALUES (1009,'Armageddon The Hot Sauce To End All','Fin del Mundo Salsa','Todo el infierno se ha desatado, fuego y azufre. Est&aacute; listo para el fin?');
INSERT INTO BLC_SKU_TRANSLATION (TRANSLATION_ID,DESCRIPTION,NAME,LONG_DESCRIPTION) VALUES (1010,'Dr. Chilemeister''s Insane Hot Sauce','Salsa Loca del Dr. Chilemeister','Aquí est&aacute; la receta para aquellos que disfrutan de picante intolerable. Esta salsa macabra y mortal del Dr. Chilemeister se debe utilizar con precauci&oacute;n. El dolor puede llegar a ser adictivo!');
INSERT INTO BLC_SKU_TRANSLATION (TRANSLATION_ID,DESCRIPTION,NAME,LONG_DESCRIPTION) VALUES (1011,'Bull Snort Cowboy Cayenne Pepper Hot Sauce','Salsa Picante del Vaquero','Espolvorear con platos de carne, pescado y verduras. Use como aditivo en la salsa de barbacoa o cualquier alimento que necesita un sabor picante. Comience con unas gotas y aumente hasta llegar al sabor deseado.');
INSERT INTO BLC_SKU_TRANSLATION (TRANSLATION_ID,DESCRIPTION,NAME,LONG_DESCRIPTION) VALUES (1012,'Cafe Louisiane Sweet Cajun Blackening Sauce','Salsa Dulce de Cajun de Lousiane','Una de las salsas m&aacute;s inusuales que vendemos. La original era un viejo estilo salsa caj&uacute;n y esto versi&oacute;n actualizada ennegrecimiento. Es dulce, pero se obtiene un gran sabor de canela y clavo de olor con un tiro agradable de piacnte de Cayena. Use en todos los alimentos para dar ese toque caj&uacute;n.');
INSERT INTO BLC_SKU_TRANSLATION (TRANSLATION_ID,DESCRIPTION,NAME,LONG_DESCRIPTION) VALUES (1013,'Bull Snort Smokin'' Toncils Hot Sauce','Salsa Mata-Gargantas de Bull Snort','Todo es m&aacute;s grande en Texas, incluso lo picante de la Salsa de Snortin Bull! Si usted es un fan de hacer la salsa de barbacoa a partir de cero, como yo, puede utilizar la Salsa de Snortin Bull como aditivo. Habaneros ardientes y los pimientos de cayena dan a la garganta un sabor y calor al rojo vivo.');
INSERT INTO BLC_SKU_TRANSLATION (TRANSLATION_ID,DESCRIPTION,NAME,LONG_DESCRIPTION) VALUES (1014,'Cool Cayenne Pepper Hot Sauce','Salsa de Cayene Fresco','Esta salsa debe su gran sabor a los pimientos de edad y vinagre de ca&ntilde;a. Mejorar&aacute; el sabor de cualquier comida.');
INSERT INTO BLC_SKU_TRANSLATION (TRANSLATION_ID,DESCRIPTION,NAME,LONG_DESCRIPTION) VALUES (1015,'Roasted Garlic Hot Sauce','Salsa de Ajo Tostado','Esta salsa debe su gran sabor a los pimientos de edad y vinagre de ca&ntilde;a. Mejorar&aacute; el sabor de cualquier comida.');
INSERT INTO BLC_SKU_TRANSLATION (TRANSLATION_ID,DESCRIPTION,NAME,LONG_DESCRIPTION) VALUES (1016,'Insanity Sauce','Salsa de Locura','Esta salsa debe su gran sabor a los pimientos de edad y vinagre de ca&ntilde;a. Mejorar&aacute; el sabor de cualquier comida.');
INSERT INTO BLC_SKU_TRANSLATION (TRANSLATION_ID,DESCRIPTION,NAME,LONG_DESCRIPTION) VALUES (1017,'Insanity Sauce','Salsa de Locura','Esta salsa debe su gran sabor a los pimientos de edad y vinagre de ca&ntilde;a. Mejorar&aacute; el sabor de cualquier comida.');
INSERT INTO BLC_SKU_TRANSLATION (TRANSLATION_ID,DESCRIPTION,NAME,LONG_DESCRIPTION) VALUES (1018,'Hurtin'' Jalepeno Hot Sauce','Salsa de Jalape&ntilde;o Ardiente','Esta salsa debe su gran sabor a los pimientos de edad y vinagre de ca&ntilde;a. Mejorar&aacute; el sabor de cualquier comida.');
INSERT INTO BLC_SKU_TRANSLATION (TRANSLATION_ID,DESCRIPTION,NAME,LONG_DESCRIPTION) VALUES (1019,'Roasted Red Pepper & Chipotle Hot Sauce','Salsa de Pimienta Roja y Chipotle','Esta salsa debe su gran sabor a los pimientos de edad y vinagre de ca&ntilde;a. Mejorar&aacute; el sabor de cualquier comida.');
-- -- Merchandise translations
INSERT INTO BLC_SKU_TRANSLATION (TRANSLATION_ID,DESCRIPTION,NAME,LONG_DESCRIPTION) VALUES (1100,'Hawt Like a Habanero Shirt (Men''s)','Camisa de Habanero Hawt (Hombres)','Colecci&oacute;n de Hombres Habanero est&aacute;ndar de manga corta serigrafiadas, camiseta de algod&oacute;n suave en ajuste normal.');
INSERT INTO BLC_SKU_TRANSLATION (TRANSLATION_ID,DESCRIPTION,NAME,LONG_DESCRIPTION) VALUES (1200,'Hawt Like a Habanero Shirt (Women''s)','Camisa de Habanero Hawt (Mujeres)','Colecci&oacute;n de Mujeres Habanero est&aacute;ndar de manga corta serigrafiadas, camiseta de algod&oacute;n suave en ajuste normal.');
INSERT INTO BLC_SKU_TRANSLATION (TRANSLATION_ID,DESCRIPTION,NAME,LONG_DESCRIPTION) VALUES (1300,'Heat Clinic Hand-Drawn (Men''s)','Heat Clinic dibujado a mano (Hombres)','Esta camiseta tiene el logo dibujado a mano para hombres, ofrece un ajuste regular en tres colores diferentes.');
INSERT INTO BLC_SKU_TRANSLATION (TRANSLATION_ID,DESCRIPTION,NAME,LONG_DESCRIPTION) VALUES (1400,'Heat Clinic Hand-Drawn (Women''s)','Heat Clinic dibujado a mano (Mujeres)','Esta camiseta tiene el logo dibujado a mano para hombres, ofrece un ajuste regular en tres colores diferentes.');
INSERT INTO BLC_SKU_TRANSLATION (TRANSLATION_ID,DESCRIPTION,NAME,LONG_DESCRIPTION) VALUES (1500,'Heat Clinic Mascot (Men''s)','Mascota de Heat Clinic (Hombres)','&iquest;No te encanta nuestra mascota? Compre su propia camiseta hoy!');
INSERT INTO BLC_SKU_TRANSLATION (TRANSLATION_ID,DESCRIPTION,NAME,LONG_DESCRIPTION) VALUES (1600,'Heat Clinic Mascot (Women''s)','Mascota de Heat Clinic (Mujeres)','&iquest;No te encanta nuestra mascota? Compre su propia camiseta hoy!');
...
-----------------------------------------------------------------------------------------------------------------------------------
-- Custom store product options in Spanish
INSERT INTO BLC_FULFILLMENT_OPTION_TRANSLATION (TRANSLATION_ID,NAME,LONG_DESCRIPTION) VALUES (1001,'Primera Clase', '2 - 7 D&iacute;as');
INSERT INTO BLC_FULFILLMENT_OPTION_TRANSLATION (TRANSLATION_ID,NAME,LONG_DESCRIPTION) VALUES (1002,'Ejecutiva', '2 - 5 D&iacute;as');
INSERT INTO BLC_FULFILLMENT_OPTION_TRANSLATION (TRANSLATION_ID,NAME,LONG_DESCRIPTION) VALUES (1003,'Express', '1 - 2 D&iacute;as');
...
-----------------------------------------------------------------------------------------------------------------------------------
-- Search facet in Spanish
INSERT INTO BLC_SEARCH_FACET_TRANSLATION (TRANSLATION_ID,LABEL) VALUES (1001,'Fabricante');
INSERT INTO BLC_SEARCH_FACET_TRANSLATION (TRANSLATION_ID,LABEL) VALUES (1002,'Rango de Calor');
INSERT INTO BLC_SEARCH_FACET_TRANSLATION (TRANSLATION_ID,LABEL) VALUES (1003,'Precio');

-- Search facet cross reference with translations
INSERT INTO BLC_SEARCH_FACET_TRANSLATION_XREF (SEARCH_FACET_ID, TRANSLATION_ID, MAP_KEY) VALUES (1, 1001, 'es');
INSERT INTO BLC_SEARCH_FACET_TRANSLATION_XREF (SEARCH_FACET_ID, TRANSLATION_ID, MAP_KEY) VALUES (2, 1002, 'es');
INSERT INTO BLC_SEARCH_FACET_TRANSLATION_XREF (SEARCH_FACET_ID, TRANSLATION_ID, MAP_KEY) VALUES (3, 1003, 'es');