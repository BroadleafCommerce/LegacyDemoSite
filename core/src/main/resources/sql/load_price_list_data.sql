...
INSERT INTO BLC_PRICE_DATA(PRICE_DATA_ID,RETAIL_PRICE,SALE_PRICE) values(1,'5.99','4.99');
...
INSERT INTO BLC_SKU_PRICE_DATA(PRICE_DATA_ID,SKU_ID,MAP_KEY) VALUES (1,17,'EUR');
INSERT INTO BLC_SKU_PRICE_DATA(PRICE_DATA_ID,SKU_ID,MAP_KEY) VALUES (1,17,'GBP');
INSERT INTO BLC_CURRENCY(CURRENCY_CODE,FRIENDLY_NAME,DEFAULT_FLAG) VALUES('USD', 'US Dollar',true);
INSERT INTO BLC_CURRENCY(CURRENCY_CODE,FRIENDLY_NAME,DEFAULT_FLAG) VALUES('EUR', 'EURO Dollar',true);
INSERT INTO BLC_CURRENCY(CURRENCY_CODE,FRIENDLY_NAME,DEFAULT_FLAG) VALUES('GBP', 'GB Pound',true);
...
INSERT INTO BLC_PRICE_LIST (PRICE_LIST_ID,CURRENCY_CODE,FRIENDLY_NAME,PRICE_KEY,USE_DEFAULT_FLAG) VALUES (2,'EUR','EUR Dollar','EUR',true);
INSERT INTO BLC_PRICE_LIST (PRICE_LIST_ID,CURRENCY_CODE,FRIENDLY_NAME,PRICE_KEY,USE_DEFAULT_FLAG) VALUES (3,'GBP','GB Pound','GBP',true);
--
