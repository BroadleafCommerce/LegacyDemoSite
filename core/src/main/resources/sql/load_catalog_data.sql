...
INSERT INTO BLC_CATEGORY (CATEGORY_ID,DESCRIPTION,NAME,URL,DEFAULT_PARENT_CATEGORY_ID,ACTIVE_START_DATE, META_DESCRIPTION, META_KEYWORDS, META_ROBOT, TITLE_FRAGMENT) VALUES (2002,'Hot Sauces','Hot Sauces','/hot-sauces',2,CURRENT_TIMESTAMP,'Heat Clinic Hot Sauces','hot, sauce, heat, peppers','INDEX,FOLLOW','Hot Sauces - Broadleaf Demo - Heat Clinic');
INSERT INTO BLC_CATEGORY (CATEGORY_ID,DESCRIPTION,NAME,URL,DEFAULT_PARENT_CATEGORY_ID,ACTIVE_START_DATE, META_DESCRIPTION, META_KEYWORDS, META_ROBOT, TITLE_FRAGMENT) VALUES (2003,'Merchandise','Merchandise','/merchandise',2,CURRENT_TIMESTAMP,'Heat Clinic Merchandise','hot, peppers, shirts, t-shirts, all sizes','INDEX,FOLLOW','Merchandise - Broadleaf Demo - Heat Clinic');
INSERT INTO BLC_CATEGORY (CATEGORY_ID,DESCRIPTION,NAME,URL,DEFAULT_PARENT_CATEGORY_ID,ACTIVE_START_DATE, META_DESCRIPTION, META_KEYWORDS, TITLE_FRAGMENT) VALUES (2004,'Clearance','Clearance','/clearance',2,CURRENT_TIMESTAMP,'Heat Clinic Clearence Sale', 'cleareance, sale, act now, offer', 'Clearance - Broadleaf Demo - Heat Clinic');
--
...
------------------------------------------------------------------------------------------------------------------
-- --Including SEO properties
INSERT INTO BLC_PRODUCT (PRODUCT_ID,  DEFAULT_CATEGORY_ID, URL, MANUFACTURE, IS_FEATURED_PRODUCT, META_DESCRIPTION, META_KEYWORDS, META_ROBOT, TITLE_FRAGMENT) VALUES (1,2002,'/hot-sauces/sudden_death_sauce','Blair''s',TRUE, 'Sudden death sauce', 'death sauce, scoville, heat, sauce', 'INDEX,FOLLOW', 'Sudden Death Sauce - Hot Sauces');
INSERT INTO BLC_PRODUCT (PRODUCT_ID,  DEFAULT_CATEGORY_ID, URL, MANUFACTURE, IS_FEATURED_PRODUCT, META_DESCRIPTION, META_KEYWORDS, META_ROBOT, TITLE_FRAGMENT) VALUES (2,2002,'/hot-sauces/sweet_death_sauce','Blair''s',FALSE, 'Sweet death sauce', 'sweet sauce, scoville, heat, sauce', 'INDEX,FOLLOW', 'Sweet Death Sauce - Hot Sauces');
INSERT INTO BLC_PRODUCT (PRODUCT_ID,  DEFAULT_CATEGORY_ID, URL, MANUFACTURE, IS_FEATURED_PRODUCT, META_DESCRIPTION, META_KEYWORDS, META_ROBOT, TITLE_FRAGMENT) VALUES (3,2002,'/hot-sauces/hoppin_hot_sauce','Salsa Express',FALSE, 'Hoppin hot sauce', 'hot sauce, scoville, heat, sauce', 'INDEX,FOLLOW', 'Hoppin'' Hot Sauce - Hot Sauces');
--
