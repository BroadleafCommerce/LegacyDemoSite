...
<html lang="en">
   ...
   <body id="bg" class="en">
       ...
       <div id="login">
           ...
           <form:form action="${pageContext.request.contextPath}/blcadmin/changePassword" method="post" cssClass="form-horizontal" modelAttribute="resetPasswordForm">
               ...
               <div class="control-group">
                   <label class="control-label" for="old_password_field">Old Password</label>
                   <div class="controls">
                       <form:password id="old_password_field" path="oldPassword" />
                   </div>
               </div>
               <div class="control-group">
