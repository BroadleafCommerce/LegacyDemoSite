...
(function($) {
  ...
  ConditionsBuilder.prototype = {
    ...
    buildConditional: function(ruleData) {
      var kind;
      if(ruleData.groupOperator == "AND" || ruleData.groupOperator == "null") { kind = "all"; }
      ...
      addConditionLink.click(function(e) {
        e.preventDefault();
        var f = _this.fields[0];
        var newField = {groupOperator: "AND", groups: [{name: f.value, operator: f.operators[0], value: null}]};
